            ...
            @if($daftarHarga && $daftarHarga->path_pdf)
                ...
                <div class="bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden reveal-on-scroll">
                    ...
                    <div class="relative" style="height: 600px;">
                        <iframe 
                            src="{{ asset('storage_public/' . $daftarHarga->path_pdf) }}" 
                            class="w-full h-full"
                            frameborder="0"
                            allowfullscreen>
                        </iframe>
                    ...
                    <div class="p-4 border-t border-slate-200 flex justify-between items-center bg-slate-50">
                        <a href="{{ asset('storage_public/' . $daftarHarga->path_pdf) }}" download class="flex items-center gap-2 px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg text-sm font-semibold transition">
            ...
            @else
                ...
                <div class="bg-white rounded-3xl border border-slate-200 shadow-sm p-12 text-center reveal-on-scroll">
                    <div class="w-16 h-16 bg-slate-100 rounded-full flex items-center justify-center mx-auto mb-4">
                        <svg class="w-8 h-8 text-slate-600 dark:text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg>
                    </div>
