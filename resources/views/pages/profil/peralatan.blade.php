    ...
    <section class="py-20 bg-slate-50 overflow-hidden">
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="flex flex-wrap gap-2 mb-10 reveal-on-scroll">
                ...
                <button onclick="filterAlat('ukur')" id="btn-ukur" class="filter-btn px-4 py-2 rounded-full text-sm font-semibold border border-slate-200 text-slate-600 hover:border-orange-400 hover:text-orange-600 transition-all">Alat Ukur</button>
                <button onclick="filterAlat('uji')" id="btn-uji" class="filter-btn px-4 py-2 rounded-full text-sm font-semibold border border-slate-200 text-slate-600 hover:border-orange-400 hover:text-orange-600 transition-all">Alat Uji</button>
                <button onclick="filterAlat('safety')" id="btn-safety" class="filter-btn px-4 py-2 rounded-full text-sm font-semibold border border-slate-200 text-slate-600 hover:border-orange-400 hover:text-orange-600 transition-all">Keselamatan</button>
            </div>
    ...
    <section class="py-14 bg-white reveal-on-scroll">
        <div class="max-w-7xl mx-auto px-6">
            <div class="bg-gradient-to-r from-blue-900 to-slate-900 rounded-3xl p-8 md:p-10 flex flex-col md:flex-row items-center gap-8 text-white">
                <div class="w-16 h-16 bg-orange-500 rounded-2xl flex items-center justify-center flex-shrink-0 shadow-lg">
                ...
                <a href="{{ route('home') }}" class="bg-orange-500 hover:bg-orange-600 text-white font-bold px-6 py-3 rounded-xl transition shadow-lg flex-shrink-0 text-sm">
                    Hubungi Kami
                </a>
            </div>
        </div>
    ...
    <div id="modal-alat" class="fixed inset-0 z-[9999] flex items-center justify-center p-4 hidden" onclick="tutupPopup(event)">
        ...
        <div class="relative bg-white rounded-3xl shadow-2xl max-w-2xl w-full z-10 overflow-hidden max-h-[90vh] flex flex-col"
            ...
            <div class="p-7 overflow-y-auto">
                ...
                <p id="modal-tipe" class="text-xs text-orange-500 font-semibold uppercase tracking-wide mb-4"></p>
                <p id="modal-deskripsi" class="text-sm text-slate-600 leading-relaxed mb-5"></p>
                <div class="border-t border-slate-100 pt-5">
                    <h4 class="text-xs font-extrabold uppercase tracking-wide text-slate-400 mb-3">Spesifikasi Teknis</h4>
    ...
    <script>
        ...
        function bukaPopup(nama, imgSrc, deskripsi, tipe, model, spesifikasi) {
            ...
            spesifikasi.forEach(item => {
                ...
                li.innerHTML = `<span class="w-1.5 h-1.5 rounded-full bg-orange-400 flex-shrink-0"></span>${item}`;
