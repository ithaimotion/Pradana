                ...
                <div id="tracking-result" class="mt-8 hidden">
                    ...
                    <div class="bg-slate-50 border border-slate-200 rounded-2xl p-5 mb-6">
                        <div class="flex items-center justify-between mb-3">
                            <div>
                                <p class="text-xs text-slate-400">No. Registrasi</p>
                        ...
                        <div class="grid grid-cols-2 gap-3 text-xs">
                            ...
                            <div>
                                <span class="text-slate-400 block">Daya</span>
    ...
    <script>
        const demoTracking = {
            'REG/2026/07/001': {
                ...
                statusBadge: 'bg-orange-100 text-orange-700 border border-orange-200',
                currentStep: 4,
