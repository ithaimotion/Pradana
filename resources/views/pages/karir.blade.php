...
@section('content')
    ...
    <section class="relative py-24 bg-gradient-to-br from-slate-900 via-blue-950 to-slate-900 text-white overflow-hidden">
        ...
        <div class="relative max-w-7xl mx-auto px-6 text-center reveal-scale">
            <span class="inline-block bg-orange-500/20 text-orange-400 border border-orange-500/30 px-4 py-1.5 rounded-full text-sm font-semibold tracking-wide uppercase mb-6 backdrop-blur-md">
                Bergabung Bersama Kami
            </span>
            <h1 class="text-4xl md:text-6xl font-extrabold mb-6 tracking-tight">
                Bangun Karir di<br>
                <span class="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-blue-400">Pradana Nusa Energi</span>
            </h1>
            <p class="text-slate-300 max-w-3xl mx-auto text-lg md:text-xl leading-relaxed mb-8">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="#lowongan" class="inline-flex items-center justify-center gap-2 px-8 py-4 bg-orange-500 hover:bg-orange-600 text-white rounded-xl font-bold transition shadow-lg shadow-orange-500/30">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path></svg>
                    Lihat Lowongan
                </a>
                <a href="#kultur" class="inline-flex items-center justify-center gap-2 px-8 py-4 bg-white/10 hover:bg-white/20 text-white rounded-xl font-bold transition border border-white/20 backdrop-blur-md">
    ...
    <section class="py-16 bg-white border-b border-slate-100">
        <div class="max-w-7xl mx-auto px-6">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8 text-center reveal-on-scroll">
                ...
                <div>
                    <div class="text-4xl md:text-5xl font-extrabold text-orange-500 mb-2">{{ $karirSettings->projects_completed ?? '500+' }}</div>
        ...
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8 reveal-on-scroll delay-100">
                ...
                @else
                    ...
                    <div class="bg-white rounded-2xl p-8 shadow-sm hover:shadow-xl transition-all duration-300 border border-slate-100 group">
                        <div class="w-14 h-14 bg-orange-100 rounded-2xl flex items-center justify-center mb-6 group-hover:bg-orange-500 transition-colors">
                            <svg class="w-7 h-7 text-orange-500 group-hover:text-white transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6"></path></svg>
                        </div>
    ...
    <section id="lowongan" class="py-20 bg-white overflow-hidden">
        <div class="max-w-7xl mx-auto px-6">
            <div class="text-center mb-16 reveal-on-scroll">
                <span class="inline-block bg-orange-100 text-orange-700 border border-orange-200 px-4 py-1.5 rounded-full text-sm font-semibold tracking-wide uppercase mb-4">
                    Lowongan Terbuka
                </span>
                        ...
                        <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
                            <div class="flex-1">
                                <div class="flex flex-wrap gap-2 mb-4">
                                    ...
                                    <span class="text-xs font-bold bg-green-500 text-white px-3 py-1.5 rounded-full">{{ $job->tipe }}</span>
                                    <span class="text-xs font-bold bg-slate-700 text-white px-3 py-1.5 rounded-full flex items-center gap-1">
                                        <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path></svg>
                                        {{ $job->lokasi }}
                                    </span>
                                </div>
                                <h4 class="text-2xl font-extrabold text-slate-900 mb-3 group-hover:text-orange-500 transition-colors">{{ $job->judul }}</h4>
                        ...
                        <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
                            <div class="flex-1">
                                <div class="flex flex-wrap gap-2 mb-4">
                                    ...
                                    <span class="text-xs font-bold bg-green-500 text-white px-3 py-1.5 rounded-full">Full Time</span>
                                    <span class="text-xs font-bold bg-slate-700 text-white px-3 py-1.5 rounded-full flex items-center gap-1">
                                        <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path></svg>
                                        Jakarta / Lapangan
                                    </span>
                                </div>
                                <h4 class="text-2xl font-extrabold text-slate-900 mb-3 group-hover:text-orange-500 transition-colors">Tenaga Teknik (Inspektur Instalasi TR & TM)</h4>
                                <p class="text-slate-600 leading-relaxed mb-4">
    ...
    <section class="py-20 bg-gradient-to-r from-blue-900 via-blue-800 to-slate-900 text-white overflow-hidden">
        ...
        <div class="relative max-w-4xl mx-auto px-6 text-center reveal-on-scroll">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="mailto:hrd@pradananusaenergi.co.id" class="inline-flex items-center justify-center gap-2 px-8 py-4 bg-orange-500 hover:bg-orange-600 text-white rounded-xl font-bold transition shadow-lg shadow-orange-500/30">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path></svg>
                    Kirim Lamaran via Email
                </a>
                <a href="tel:+6221XXXXXXX" class="inline-flex items-center justify-center gap-2 px-8 py-4 bg-white/10 hover:bg-white/20 text-white rounded-xl font-bold transition border border-white/20 backdrop-blur-md">
