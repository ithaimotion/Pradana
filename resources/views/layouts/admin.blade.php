            ...
            <nav class="space-y-0.5">
                ...
                <div class="mb-2">
                    <button @click="switchTab('dashboard')"
                        :class="activeTab === 'dashboard' && activeGroup === '' && isAdminRoot() ? 'bg-orange-500/15 text-orange-400 border-orange-500/30 font-bold' : 'text-slate-400 hover:text-white hover:bg-slate-800/60 border-transparent'"
                        class="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl border text-xs transition-all font-medium">
                        <svg class="w-4 h-4 shrink-0" :class="activeMenu === 'dashboard' && isAdminRoot() ? 'text-orange-400' : 'text-slate-500'" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path></svg>
                        Dashboard
                    </button>
                </div>
                ...
                <div class="mb-2">
                    <button @click="switchTab('hero', 'beranda')"
                        :class="isActiveGroup('beranda') && isAdminRoot() ? 'bg-orange-500/15 text-orange-400 border-orange-500/30 font-bold' : 'text-slate-400 hover:text-white hover:bg-slate-800/60 border-transparent'"
                        class="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl border text-xs transition-all font-medium">
                ...
                <div>
                    ...
                    <div x-show="openGroups.profil" x-transition:enter="transition ease-out duration-150" x-transition:enter-start="opacity-0 -translate-y-1" x-transition:enter-end="opacity-100 translate-y-0" x-cloak class="mt-0.5 ml-5 pl-3 border-l border-slate-800 space-y-0.5">
                        <button @click="switchTab('profil', 'profil')" :class="isActiveTab('profil', 'profil') && isAdminRoot() ? 'text-orange-400 font-bold bg-orange-500/10' : 'text-slate-400 hover:text-white hover:bg-slate-800/50'" class="w-full text-left px-3 py-2 rounded-lg text-xs transition-all">Header & Ringkasan Profil</button>
                ...
                <div>
                    ...
                    <div x-show="openGroups.slo" x-transition:enter="transition ease-out duration-150" x-transition:enter-start="opacity-0 -translate-y-1" x-transition:enter-end="opacity-100 translate-y-0" x-cloak class="mt-0.5 ml-5 pl-3 border-l border-slate-800 space-y-0.5">
                        <button @click="switchTab('slo-regulasi', 'slo')" :class="isActiveTab('slo-regulasi', 'slo') && isAdminRoot() ? 'text-orange-400 font-bold bg-orange-500/10' : 'text-slate-400 hover:text-white hover:bg-slate-800/50'" class="w-full text-left px-3 py-2 rounded-lg text-xs transition-all">Regulasi</button>
                ...
                <div>
                    ...
                    <div x-show="openGroups.infopub" x-transition:enter="transition ease-out duration-150" x-transition:enter-start="opacity-0 -translate-y-1" x-transition:enter-end="opacity-100 translate-y-0" x-cloak class="mt-0.5 ml-5 pl-3 border-l border-slate-800 space-y-0.5">
                        ...
                        <a href="{{ route('admin.informasi-publik.uji-petik.index') }}" class="w-full text-left px-3 py-2 rounded-lg text-xs transition-all block {{ request()->is('admin/informasi-publik/uji-petik*') ? 'text-orange-400 font-bold bg-orange-500/10' : 'text-slate-400 hover:text-white hover:bg-slate-800/50' }}">Uji Petik</a>
                        <a href="{{ route('admin.informasi-publik.keluhan-banding.index') }}" class="w-full text-left px-3 py-2 rounded-lg text-xs transition-all block {{ request()->is('admin/informasi-publik/keluhan-banding*') ? 'text-orange-400 font-bold bg-orange-500/10' : 'text-slate-400 hover:text-white hover:bg-slate-800/50' }}">Keluhan & Banding</a>
                        ...
                        <div>
                            ...
                            <div x-show="openSub === 'standar'" x-transition x-cloak class="ml-3 pl-3 border-l border-slate-800/60 space-y-0.5 mt-0.5">
                                <a href="{{ route('admin.informasi-publik.persyaratan-slo.index') }}" class="w-full text-left px-3 py-1.5 rounded-lg text-xs transition-all block {{ request()->is('admin/informasi-publik/persyaratan-slo*') ? 'text-orange-400 font-bold bg-orange-500/10' : 'text-slate-500 hover:text-white hover:bg-slate-800/50' }}">Persyaratan SLO</a>
                                <a href="{{ route('admin.informasi-publik.daftar-harga-slo.index') }}" class="w-full text-left px-3 py-1.5 rounded-lg text-xs transition-all block {{ request()->is('admin/informasi-publik/daftar-harga-slo*') ? 'text-orange-400 font-bold bg-orange-500/10' : 'text-slate-500 hover:text-white hover:bg-slate-800/50' }}">Daftar Harga SLO</a>
                                <a href="{{ route('admin.informasi-publik.prosedur-slo.index') }}" class="w-full text-left px-3 py-1.5 rounded-lg text-xs transition-all block {{ request()->is('admin/informasi-publik/prosedur-slo*') ? 'text-orange-400 font-bold bg-orange-500/10' : 'text-slate-500 hover:text-white hover:bg-slate-800/50' }}">Prosedur SLO</a>
                                <a href="{{ route('admin.informasi-publik.alur-sertifikasi.index') }}" class="w-full text-left px-3 py-1.5 rounded-lg text-xs transition-all block {{ request()->is('admin/informasi-publik/alur-sertifikasi*') ? 'text-orange-400 font-bold bg-orange-500/10' : 'text-slate-500 hover:text-white hover:bg-slate-800/50' }}">Alur Sertifikasi</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    <button @click="switchTab('logo')"
                        :class="activeTab === 'logo' && activeGroup === '' && isAdminRoot() ? 'bg-violet-500/15 text-violet-400 border-violet-500/30 font-bold' : 'text-slate-400 hover:text-white hover:bg-slate-800/60 border-transparent'"
                        class="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl border text-xs transition-all font-medium">
                ...
                <div>
                    ...
                    <div x-show="openGroups.karir" x-transition:enter="transition ease-out duration-150" x-transition:enter-start="opacity-0 -translate-y-1" x-transition:enter-end="opacity-100 translate-y-0" x-cloak class="mt-0.5 ml-5 pl-3 border-l border-slate-800 space-y-0.5">
                        ...
                        <a href="{{ route('admin.karir-settings.index') }}" class="w-full text-left px-3 py-2 rounded-lg text-xs transition-all block {{ request()->is('admin/karir-settings*') ? 'text-orange-400 font-bold bg-orange-500/10' : 'text-slate-400 hover:text-white hover:bg-slate-800/50' }}">Pengaturan Halaman</a>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div x-show="openGroups.kontak" x-transition:enter="transition ease-out duration-150" x-transition:enter-start="opacity-0 -translate-y-1" x-transition:enter-end="opacity-100 translate-y-0" x-cloak class="mt-0.5 ml-5 pl-3 border-l border-slate-800 space-y-0.5">
                        <button @click="switchTab('kontak', 'kontak')" :class="isActiveTab('kontak', 'kontak') && isAdminRoot() ? 'text-orange-400 font-bold bg-orange-500/10' : 'text-slate-400 hover:text-white hover:bg-slate-800/50'" class="w-full text-left px-3 py-2 rounded-lg text-xs transition-all">Banner Kontak</button>
