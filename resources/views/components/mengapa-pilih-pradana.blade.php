...
@php
    ...
    $img2 = (!empty($header->nilai) && (str_starts_with($header->nilai, 'http://') || str_starts_with($header->nilai, 'https://'))) ? $header->nilai : (($header->nilai ?? null) ? asset('storage/' . $header->nilai) : 'https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80');
