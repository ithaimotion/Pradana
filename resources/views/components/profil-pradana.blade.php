...
@php
    ...
    $img2 = (!empty($profil->nilai) && (str_starts_with($profil->nilai, 'http://') || str_starts_with($profil->nilai, 'https://'))) ? $profil->nilai : (($profil->nilai ?? null) ? asset('storage/' . $profil->nilai) : 'https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80');
@endphp
