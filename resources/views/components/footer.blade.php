    ...
    <div class="max-w-7xl mx-auto px-6 py-16">
        <div class="grid md:grid-cols-4 gap-12 mb-12 reveal-on-scroll">
            ...
            <div>
                ...
                <ul class="space-y-2">
                    <li><a href="{{ route('profil.perusahaan') }}" class="text-white/70 hover:text-orange-500 transition">Profil Perusahaan</a></li>
                    <li><a href="#about" class="text-white/70 hover:text-orange-500 transition">Tentang Kami</a></li>
                    <li><a href="#products" class="text-white/70 hover:text-orange-500 transition">Layanan SLO</a></li>
                    <li><a href="#technology" class="text-white/70 hover:text-orange-500 transition">Regulasi & Standar</a></li>
                    <li><a href="#contact" class="text-white/70 hover:text-orange-500 transition">Kontak</a></li>
                </ul>
            </div>
        ...
        <div class="border-t border-white/20 pt-8 mb-8 reveal-on-scroll delay-200">
            <div class="flex justify-end gap-4">
                    <a href="#" class="w-10 h-10 bg-white/10 rounded-full flex items-center justify-center hover:bg-orange-500 transition">
