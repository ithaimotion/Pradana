...
<div {{ $attributes->merge(["class" => "rounded-3xl p-4 border {$style['border']} {$style['bg']} shadow-xl shadow-black/20"] ) }}>
    <div class="flex gap-4">
        <div class="mt-1 flex h-11 w-11 items-center justify-center rounded-2xl bg-slate-100 dark:bg-white/10">
        ...
        <div class="min-w-0 space-y-2">
            ...
            @if(!empty($errors))
                <div class="mt-3 rounded-2xl border border-slate-200 dark:border-white/10 bg-slate-50 dark:bg-white/5 p-3">
                    <p class="text-[11px] uppercase tracking-[0.2em] text-slate-600 dark:text-slate-400 mb-2">Detail</p>
