...
<div class="p-6">
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-white">Kelola: Alur Sertifikasi</h1>
        <p class="text-slate-400 mt-1">Kelola dokumen PDF alur sertifikasi SLO</p>
    </div>
    ...
    <div class="bg-slate-800 rounded-xl border border-slate-700 p-6">
        <form action="{{ route('admin.informasi-publik.alur-sertifikasi.update') }}" method="POST" enctype="multipart/form-data">
            ...
            <!-- Nama Dokumen -->
            <div class="mb-6">
                <label class="block text-slate-300 text-sm font-medium mb-2">Nama Dokumen</label>
                <input 
                    type="text" 
                    name="nama_dokumen" 
            ...
            <!-- Upload PDF -->
            <div class="mb-6">
                <label class="block text-slate-300 text-sm font-medium mb-2">Upload PDF</label>
                <div class="border-2 border-dashed border-slate-600 rounded-lg p-6 text-center hover:border-blue-500 transition-colors">
                    ...
                    <label for="pdf-upload" class="cursor-pointer">
                        <div class="flex flex-col items-center">
                            ...
                            <p class="text-slate-400 text-sm">Klik untuk upload PDF</p>
                ...
                @if($alurSertifikasi && $alurSertifikasi->path_pdf)
                    <div class="mt-3 flex items-center justify-between bg-slate-700 rounded-lg px-4 py-3">
                        <div class="flex items-center gap-3">
                            <svg class="w-5 h-5 text-red-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                            </svg>
                            <span class="text-slate-300 text-sm truncate max-w-xs">{{ $alurSertifikasi->nama_dokumen }}</span>
                        </div>
            ...
            <div class="mb-6">
                <label class="flex items-center gap-3 cursor-pointer">
                    <input 
                        ...
                        class="w-5 h-5 rounded border-slate-600 bg-slate-700 text-blue-500 focus:ring-blue-500 focus:ring-offset-slate-800"
                    >
                    <span class="text-slate-300 text-sm font-medium">Tampilkan di halaman publik</span>
                </label>
            </div>
