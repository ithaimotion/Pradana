...
<div class="space-y-6">
    ...
    <div class="flex items-center gap-4">
        ...
        <div>
            <h1 class="text-2xl font-bold text-white">Kelola Uji Petik</h1>
            <p class="text-slate-400 text-sm mt-1">Upload gambar uji petik inspeksi</p>
        </div>
    </div>
    ...
    <div class="bg-slate-800/50 border border-slate-700 rounded-xl p-6">
        <form action="{{ route('admin.informasi-publik.uji-petik.update') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <!-- Upload Gambar -->
            <div class="space-y-4">
                <label class="block text-sm font-semibold text-slate-300 mb-2">Gambar Uji Petik</label>
