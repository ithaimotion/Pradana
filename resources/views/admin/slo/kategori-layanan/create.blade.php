...
<div class="space-y-6">
    ...
    <div class="flex items-center gap-4">
        ...
        <div>
            <h1 class="text-2xl font-bold text-slate-900 dark:text-white">Tambah Kategori Layanan SLO</h1>
            <p class="text-slate-600 dark:text-slate-400 text-sm mt-1">Tambah kategori layanan inspeksi baru</p>
        </div>
    </div>
