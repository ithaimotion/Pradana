...
<div class="space-y-6">
    <div class="bg-slate-900/80 backdrop-blur-xl border border-slate-800 rounded-2xl p-6 sm:p-8 shadow-xl">
        <div class="mb-6">
            ...
            <p class="text-xs text-slate-400 mt-1">Isi form di bawah untuk membuat profil perusahaan baru</p>
        </div>
            ...
            <div class="space-y-4 bg-slate-950/40 p-5 rounded-xl border border-slate-800/80">
                ...
                <div class="grid md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="judul" value="{{ old('judul') }}" placeholder="Contoh: PT PRADANA NUSA ENERGI" class="w-full bg-slate-950 border border-slate-800 rounded-xl p-2.5 text-sm text-slate-100 focus:outline-none focus:border-amber-500">
                        @error('judul')
                    ...
                    <div>
                        ...
                        <textarea name="subjudul" rows="2" class="w-full bg-slate-950 border border-slate-800 rounded-xl p-2.5 text-sm text-slate-100 focus:outline-none focus:border-amber-500" placeholder="Lembaga Inspeksi Teknik (LIT) terkemuka dan terpercaya...">{{ old('subjudul') }}</textarea>
                        @error('subjudul')
                            <p class="text-red-400 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="grid md:grid-cols-2 gap-6">
                    <div class="space-y-3">
                        <div>
                            ...
                            <input type="text" name="nilai" value="{{ old('nilai') }}" class="w-full bg-slate-950 border border-slate-800 rounded-xl p-2.5 text-sm text-slate-100 focus:outline-none focus:border-amber-500" placeholder="Komitmen Kami Terhadap Keselamatan & Ketenagalistrikan">
                            @error('nilai')
                                <p class="text-red-400 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        <div>
                            ...
                            <textarea name="konten" rows="5" class="w-full bg-slate-950 border border-slate-800 rounded-xl p-2.5 text-sm text-slate-100 focus:outline-none focus:border-amber-500" placeholder="Deskripsi komitmen perusahaan...">{{ old('konten') }}</textarea>
                            @error('konten')
                                <p class="text-red-400 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
            ...
            <div class="space-y-4 bg-slate-950/40 p-5 rounded-xl border border-slate-800/80">
                ...
                <div class="grid md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <textarea name="visi" rows="4" class="w-full bg-slate-950 border border-slate-800 rounded-xl p-2.5 text-sm text-slate-100 focus:outline-none focus:border-amber-500" placeholder="Menjadi Lembaga Inspeksi Teknik yang...">{{ old('visi') }}</textarea>
                        @error('visi')
                            <p class="text-red-400 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    <div>
                        ...
                        <textarea name="misi" rows="4" class="w-full bg-slate-950 border border-slate-800 rounded-xl p-2.5 text-sm text-slate-100 focus:outline-none focus:border-amber-500" placeholder="1. Melaksanakan pemeriksaan...">{{ old('misi') }}</textarea>
                        @error('misi')
                            <p class="text-red-400 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    </div>
