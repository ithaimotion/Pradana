...
{
    /**
     * Update Konten Sub-Menu Halaman Profil (Perusahaan, PJT/TT, Struktur, Legalitas, Peralatan, SOP).
     */
    public function update(Request $request)
    {
        ...
        if ($request->hasFile('gambar')) {
            ...
            $konten->path_gambar = $request->file('gambar')->store('uploads/profil', 'public');
        }
